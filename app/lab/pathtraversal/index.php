...
<header>
    ...
    <img src="../pathtraversal/images/yavuzlar.png" alt="Logo" width="100" height="100" class="d-inline-block align-text-top">
</header>

<div class="products-container">
    <div class="product" onclick="goToProductPage(1)">
        <img src="../pathtraversal/images/clop.jpg" alt="Ürün 1 Resmi" width="300" height="240">
    ...
    <div class="product" onclick="goToProductPage(2)">
        <img src="../pathtraversal/images/Anonymous.jpeg" alt="Ürün 2 Resmi" width="300" height="240">
    ...
    <div class="product" onclick="goToProductPage(3)">
        <img src="../pathtraversal/images/LazarusGroup.jpg" alt="Ürün 2 Resmi" width="300" height="240">
    ...
    <div class="product" onclick="goToProductPage(4)">
        <img src="../pathtraversal/images/carbanak.jpg" alt="Ürün 2 Resmi" width="300" height="240">
    ...
    <div class="product" onclick="goToProductPage(5)">
        <img src="../pathtraversal/images/TheDarkOverlord.jpg" alt="Ürün 2 Resmi" width="300" height="240">
    ...
    <div class="product" onclick="goToProductPage(6)">
        <img src="../pathtraversal/images/TheEquationGroup.jpg" alt="Ürün 2 Resmi" width="300" height="240">
    ...
    <div class="product" onclick="goToProductPage(7)">
        <img src="../pathtraversal/images/ta505.jpg" alt="Ürün 2 Resmi" width="300" height="240">
    ...
    <div class="product" onclick="goToProductPage(8)">
        <img src="../pathtraversal/images/darkside.jpg" alt="Ürün 2 Resmi" width="300" height="240">
    ...
    <div class="product" onclick="goToProductPage(9)">
        ...
        <img src="../pathtraversal/images/morpho1.jpg" alt="Ürün 2 Resmi" width="300" height="240">
    ...
    <div class="product" onclick="goToProductPage(10)">
        <img src="../pathtraversal/images/Lapsus.jpg" alt="Ürün 2 Resmi" width="300" height="240">
