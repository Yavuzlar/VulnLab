...
if (isset($_POST['message'])) {
	...
	header("Location: messageYavuzlar.php");
					...
					<div class="py-2 px-4 border-bottom d-none d-lg-block">
						<div class="d-flex align-items-center py-1">
							<div class="position-relative">
								<img src="img/yavuzlar.png" class="rounded-circle mr-1" alt="Sharon Lessman" width="40" height="40">
							</div>
							<div class="flex-grow-1 pl-3">
								<strong><?php echo $strings['yavuzlar_expert']; ?></strong>
						...
						<div class="chat-messages p-4">
							...
							<div class="chat-message-left pb-4">
								...
								<div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
									<div class="font-weight-bold mb-1"><?php echo $strings['yavuzlar_expert']; ?></div>
									<?php echo $strings['yavuzlar_expert_mess1']; ?>
								</div>
							</div>
                            <div class="chat-message-left pb-4">
								<div>
								...
								<div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
									<div class="font-weight-bold mb-1"><?php echo $strings['yavuzlar_expert']; ?></div>
                                    <?php echo $strings['yavuzlar_expert_mess2']; ?>						
                                </div>
							</div>
                            ...
                            <?php
                                $productsDB = $conn->prepare("SELECT * FROM shopYavuzlar ORDER BY id");
                                $productsDB->execute();
                                $messages = $productsDB->fetchAll(PDO::FETCH_ASSOC);
                                foreach ($messages as $message) {
                                    if($message["corner"] == 0){
										$name = $strings['yavuzlar_expert'];
                                        echo ' 
                                        <div class="chat-message-left pb-4">
                                            <div>
                                                <img src="img/yavuzlar.png" class="rounded-circle mr-1" alt="Sharon Lessman" width="40" height="40">
...
<!-- 					
	 ...
	 -->
                ...
                <form id="message-form"  action="messageYavuzlar.php" method="POST">
